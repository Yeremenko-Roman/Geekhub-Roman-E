...
function videoembedder_options_page() {
	...
	<table width='100%' border='0' cellspacing='0' cellpadding='0'>
		...
		<tr>
			<th><strong>Funny or Die тег:</strong></th>
			<td><input name='funnyordie_tag' type='text' id='funnyordie_tag' value='$funnyordie_tag'> Использование: [$funnyordie_tag]video_id[/$funnyordie_tag]</td>
		</tr>
		<!-- local media -->
		<tr>
	...
	echo '<p>Для вставки видео-ролика Youtube movies используйте выделенную красным часть ссылки: http://www.youtube.com/watch?v=<strong style="color:red;">zORv8wwiadQ</strong></p>';
	...
	echo '<p>Для вставки видео-ролика Metacafe используйте выделенную красным часть ссылки: http://www.metacafe.com/watch/<strong style="color:red;">975366/secrets_of_google_earth</strong>/ (the trailing slash should not be included)</p>';
	...
	echo '<h3>Funny or Die помощь</h3>';
	echo '<p>Для вставки видео-ролика Funny or Die используйте выделенную красным часть ссылки: http://www.funnyordie.com/videos/<strong style="color:red;">1785f25c3f</strong></p>';
	echo '<p>Наберите ['.$funnyordie_tag.']<strong style="color:red;">1785f25c3f</strong>[/'.$funnyordie_tag.'] в редакторе, чтобы встроить видео.</p>';
