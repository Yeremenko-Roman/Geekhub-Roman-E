...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Ваш сервер запущен на PHP версии %s, а WordPress требует как минимум 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'В Вашей инсталляции PHP, по-видимому, отсутствует расширение MySQL, необходимое для WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>ОШИБКА</strong>: <code>$table_prefix</code> в <code>wp-config.php</code> может содержать только латинские буквы, цифры и символ подчеркивания.'/*/WP_I18N_BAD_PREFIX*/);
